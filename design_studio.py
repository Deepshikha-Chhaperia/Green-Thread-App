...
def generate_qr_code(design_id, materials, clothing_type, style):
    ...
    vercel_domain = "your-vercel-app.vercel.app"
    
    qr_data = {
        "id": qr_code_id,
        "design_id": str(design_id),
        # Use the Vercel URL for verification
        "verify_url": f"https://{vercel_domain}/{qr_code_id}"
    }
...
def display_design_studio():
    ...
    with col2:
        ...
        if st.session_state.generated_design:
            ...
            4. View your garment's care instructions instantly - works offline!
            """)
